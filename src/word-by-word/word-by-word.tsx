...
export const WordByWord = () => {
    ...
    if (!chapter) {
        console.error(`Chapter ${chapterNumber} data not available.`);
        // You can set an error state or return a fallback UI component here.
        return <div>Chapter data is not available.</div>;
    }
